...
class CurrencyInputFormatter extends TextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(
    ...
    final newNumberOfProcedingSeparators =
        formattedText.characters.where((p0) => p0 == thousandSeparator).length;
    final additionalOffset =
        newNumberOfProcedingSeparators - initialNumberOfPrecedingSeparators;
